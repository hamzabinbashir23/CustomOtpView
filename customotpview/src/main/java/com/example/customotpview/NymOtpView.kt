...
import com.example.customotpview.databinding.ItemOtpDashBinding
import com.example.customotpview.databinding.ItemOtpSymbolBinding
import com.example.customotpview.databinding.NymOtpViewBinding
...
class NymOtpView @JvmOverloads constructor(
    ...
    fun setActiveFieldBackground() {
        val drawable =
            otpTextListeners?.let {
                getDrawable(
                    strokeColor,
                    fieldBGColor,
                    fieldRadius,
                    it.activeStrokeColor
                )
            }
